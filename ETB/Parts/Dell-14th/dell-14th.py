...
olink="https://www.etb-tech.com/parts/dell-14th-generation-servers"
...
# The code has gottne up to this point but its not being executed after this. Also images are not being saved
            for x_image2 in image2:
                ...
                if product_image_link != "#":
                    ...
                    new_name=product_info1.replace("/","per")
                    driver.get_screenshot_as_file(current_directory+ "\\" +new_name+product_info2+"("+str(counter_image)+")" +".png")
