...
olink="https://www.etb-tech.com/components/raid-sas-controllers"
...
header_thirty= ["Detail","Sub-Detail","Link Page", 'Model', 'Memory Size','Memory Type', 'Memory Bus' ,"Memory Bandwidth", "Base Clock", "Turbo Clock", "Thermal Solution", "Height", "Length", "Bracket", "Outputs","Maximum Power Consumption","Power Connectors Required", "Additional Information"]
