...
olink="https://www.etb-tech.com/components/processors"
...
#driver.close()
header= ["Detail","Sub-Detail", "Link Page",'Model', 'No. of Cores', 'No. of Threads' ,"Base Frequency", "Max Turbo Frequency", "Cache", "TDP", "CPU Socket Type", "CPU Family", "Step Code", "Additional Information" ]
