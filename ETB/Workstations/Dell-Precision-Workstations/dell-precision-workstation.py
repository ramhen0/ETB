...
olink="https://www.etb-tech.com/servers/precision-workstations/tower-workstations"
...
# Header for 24
header_twentyfour= ["Detail","Sub-Detail","Link Page", 'CPU', 'Graphics Card' ,'RAM', 'Hard Drives' ,"RAID Controller", "Network Card","Power Supply", "Remote Access", "Rack Rails", "Bezel", "Backplane", "Chassis Type" ,"Additional Information"]
...
header_thirty= ["Detail","Sub-Detail","Link Page", 'CPU', 'Graphics Card' ,'RAM', 'Hard Drives','SSD' ,"RAID Controller", "Network Card", 'Risers',"Power Supply", "Remote Access", "Rack Rails", "Bezel", "Backplane", "Chassis Type" ,"Additional Information"]
