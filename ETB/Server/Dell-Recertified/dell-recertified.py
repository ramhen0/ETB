...
counter1=0
olink="https://www.etb-tech.com/servers/dell-re-certified-servers"
...
outer_iterations=math.ceil(int(total_number)/60)+1
...
#driver.close()
header= ["Detail","Sub-Detail","Link Page", 'CPU', 'RAM', 'Hard Drives' ,"RAID Controller", "Network Card", "Power Supply", "Remote Access", "Rack Rails", "Bezel", "BackPlanes", "Chassis Type", "Additional Information", "Warranty"]
