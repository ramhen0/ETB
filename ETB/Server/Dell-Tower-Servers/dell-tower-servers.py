...
counter1=0
olink="https://www.etb-tech.com/servers/dell-tower-servers"
...
#driver.close()
header= ["Detail","Sub-Detail", "Link Page",'CPU', 'RAM', 'Hard Drives' ,"RAID Controller", "Network Card", "Power Supply", "Remote Access", "Rack Rails", "Bezel", "BackPlanes", "Chassis Type", "Additional Information"]
