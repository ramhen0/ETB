...
olink="https://www.etb-tech.com/networking/cisco-switches-routers/nexus"
...
# Header for 24
header= ["Detail","Sub-Detail","Link Page", 'Model', 'Ports', 'Active Ports (Licensed)','Transceivers Included' ,"Power Over Ethernet (PoE)", "Power Supplies Installed", "Air Flow", "Module Expansion Slots","Memory","Storage","Operating System", "Licenses Installed","Switching Capacity","Management","Chassis Type","Rack Mounting Kit","Smart Net Eligible" ,"Additional Information"]
