# Tech Sheet
# table and no notable
# If it starts with compellent than it has description if it starts with dell then table
...
pattern1='\ADell Connectrix'
pattern2="\ADell EMC"


olink="https://www.etb-tech.com/networking/other-switches/brocade-switches"
...
# if else statments
        result1=re.search(pattern1,product_info1)
        result2=re.search(pattern2,product_info1)
...
# it opened the second product images but didnt take the screenshot
        ...
        if tech_sheet_link is None:
            ...
            with open(name_for_pics_again+".pdf", 'wb') as f:
...
# Header for 24
header= ["Detail","Sub-Detail","Link Page", 'Model', 'Ports', 'Licensed Ports' ,"Power Over Ethernet (PoE)","Layer", "Power Supplies Installed", "Air Flow", "Module Expansion Slots", "Operating System", "Licenses Installed","Management","Chassis Type","Rack Mounting Kit" ,"Additional Information"]
