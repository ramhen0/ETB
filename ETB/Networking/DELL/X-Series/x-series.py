...
counter1=0
olink="https://www.etb-tech.com/networking/dell-switches/dell-networking-x-series"
...
#driver.close()
header= ["Detail","Sub-Detail","Link Page", 'Model', 'Ports', 'Accessory Parts' ,"Power Over Ethernet (PoE)", "Layer", "Power Supplies Installed", "Air Flow", "Rack Rails", "Module Expansion Slots", "Operating System", "Licenses Installed","Management","Chassis Type","Rack Mounting Kit", "Additional Information"]
